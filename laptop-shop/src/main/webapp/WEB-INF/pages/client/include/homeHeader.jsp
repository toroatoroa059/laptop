		...
		<div class="wrap">
			...
			<div class="top-nav">
				<ul>
					...
					<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="<%=request.getContextPath()%>/store">Cửa hàng 
					 <span class="caret"></span>
					 </a>
						<ul class="dropdown-menu" style="background: #94cb32" id="danhmuc"> <a href="<%=request.getContextPath()%>/store"> </a>
						</ul>
					</li>
