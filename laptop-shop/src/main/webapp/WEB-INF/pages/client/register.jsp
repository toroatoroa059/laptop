...
<body>
	...
	<div class="login-page">
		<div class="form">
			<form:form method="POST" action='register' modelAttribute="newUser">
				...
				<div class="form-group">
					<form:input type="password" id="passwords" path="password" class="form-control" 
				...
				<div class="form-group">
					<form:input type="number" path="soDienThoai" id="telephone" class="form-control"
						placeholder="Số điện thoại" required="required"></form:input>
					<form:errors class="error" path="soDienThoai"></form:errors>
				</div>
	...
	<script
		...
		<script src="<c:url value='/js/client/register.js'/>" ></script>
