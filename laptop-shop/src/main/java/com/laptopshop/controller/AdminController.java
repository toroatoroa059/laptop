...
import com.laptopshop.repository.ThongKeRepository;
...
//	private ThongKeService thongKeService;
	...
	// Thống kê theo sản phẩm được bán ra
		@GetMapping(value = "/thong-ke/reportOrderCustomer")
		public String report(Model model) throws SQLException {
			
			List<Object> customers = thongKeRepo.repo();
			model.addAttribute("customers", customers);
			System.out.println(customers.size());
			return "admin/thongketheonguoidung";
		}
		
	// Thống kê   theo khach hang	
